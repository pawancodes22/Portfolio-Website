          ...
          <Col>
            <div className="skill-box">
              ...
              <p className="skill-para">
                ...
                Bootstrap, JavaScript, React.js <br />{" "}
              ...
              <Carousel responsive={responsive} infinite={true}>
                <div>
                  <img className="carousel-img" src={meter1} alt="carousel" />
                  <h5 className="text-center mt-4">Front End Development</h5>
                </div>
                <div>
                  <img className="carousel-img" src={meter2} alt="carousel" />
                  <h5 className="text-center mt-4">Back End Development</h5>
                </div>
                <div>
                  <img className="carousel-img" src={meter3} alt="carousel" />
                  <h5 className="text-center mt-4">Sqlite</h5>
                </div>
                <div>
